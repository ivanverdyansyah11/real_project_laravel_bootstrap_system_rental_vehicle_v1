                            ...
                            <div class="input-wrapper">
                                <div class="wrapper d-flex gap-3 align-items-end">
                                    ...
                                    <div class="wrapper-image w-100">
                                        <input {{ $pelepasan_pemesanan->foto_dokumen ? '' : 'required' }} type="file"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
                            <div class="input-wrapper">
                                <div class="wrapper d-flex gap-3 align-items-end">
                                    ...
                                    <div class="wrapper-image w-100">
                                        <input {{ $pelepasan_pemesanan->foto_kendaraan ? '' : 'required' }} type="file"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
                            <div class="input-wrapper">
                                <div class="wrapper d-flex gap-3 align-items-end">
                                    ...
                                    <div class="wrapper-image w-100">
                                        <input {{ $pelepasan_pemesanan->foto_pelanggan ? '' : 'required' }} type="file"
